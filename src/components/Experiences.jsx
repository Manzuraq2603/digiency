        ...
        <section className="py-15 bg-[#FFF7F4]">
            <div className="max-w-[1250px] mx-auto px-10 flex md:flex-row flex-col gap-[30px] justify-between items-center">
                <div className="lg:max-w-[570px] md:max-w-83 w-full mt-[33px] ">
                    <p className="font-normal text-[#7B7B7B] text-base leading-[151%] lg:mb-[25px] md:mb-[18px] md:text-start text-center   ">
                        Our Expereince
                    </p>
                ...
                <div className="flex lg:gap-[30px] md:gap-2">
                    <ul className="flex flex-col lg:gap-[30px] md:gap-2 lg:mt-0 md:mt-[45px]">
                        <li className="lg:w-[270px] lg:h-[250px] md:w-[162px] md:h-[150px] bg-white flex flex-col justify-center items-center shadow-[0px_1px_10px_0px_#0000001A]">
                            <h1 className="text-[#373737] lg:font-bold md:font-medium lg:text-5xl md:text-[25px] leading-[124%]">
                                250+
                            </h1>
                    ...
                    <ul className="flex flex-col lg:gap-[30px] md:gap-2 lg:mt-[23px] md:mt-[77px]">
                        <li className="lg:w-[270px] lg:h-[250px] md:w-[162px] md:h-[150px] bg-white flex flex-col justify-center items-center shadow-[0px_1px_10px_0px_#0000001A]">
                            <h1 className="text-[#373737] lg:font-bold md:font-medium lg:text-5xl md:text-[25px] leading-[124%]">
                                156+
                            </h1>
