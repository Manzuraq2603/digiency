...
function Hero() {
    return (
        <section className="lg:py-[153px] md:py-[73px] py-[50px] bg-[#FFF7F4] flex">
            <div className="max-w-[1250px] mx-auto px-10 flex justify-between items-center gap-[35px] md:flex-row flex-col-reverse">
                <div className="lg:max-w-[493px] md:max-w-[50%] w-full md:mr-auto">
                    ...
                    <div className="flex items-center md:justify-start justify-center">
                        <button className="font-medium text-xl leading-[124%] rounded-[5px] lg:mt-[50px]  mt-[25px] pl-[19px] pr-[22px] pt-[13px] pb-4 text-white bg-[#FF5300] cursor-pointer border-2 border-transparent hover:text-[#FF5300] hover:border-2 hover:border-[#FF5300] hover:bg-white transition-all duration-[0.4s] ease-in">
                            Contact Us
                        </button>
                    </div>
                </div>
