...
function Footer() {
    return (
        <footer className="bg-[#373737]">
            <div className="max-w-[1250px] mx-auto px-10 pt-[66px] pb-[60px] ">
                <ul className="text-white flex">
                    <li className="max-w-[263px] w-full mr-[37px]">
                        <img
                            className="w-[162px] h-12"
                            src={footerDigiency}
                            alt="logo"
                            width={162}
                            height={48}
                        />
                        <p className="font-normal text-base mt-[25px]  leading-[151%]">
                            Lorem ipsum dolor sit amet, consectetur adipiscing
                            elit. Sit a laoreet libero dis eget maecenas
                            bibendum.
                        </p>
                        <div className="flex flex-row gap-[27px] mt-[18px]">
                            <a
                            ...
                            <a
                                className=" w-10 h-10 bg-white hover:bg-[#FF5300] text-[#FF5300] hover:text-white flex items-center justify-center "
                    ...
                    <li className="max-w-[179px] w-full mr-30">
                        <h2 className="font-semibold text-[39px] leading-[124%] ">
                            Company
                        </h2>
                        <ul className="flex flex-col gap-[10px]">
                            <li className="font-normal text-base mt-[25px]  leading-[151%]">
                                About Us
                            </li>
                    ...
                    <li className="max-w-[145px] w-full mr-39">
                        <h2 className="font-semibold text-[39px] leading-[124%] ">
                            Sevices
                        </h2>
                        <ul className="flex flex-col gap-[10px]">
                    ...
                    <li className="max-w-[270px] w-full">
                        <h2 className="font-semibold text-[39px] leading-[124%] ">
                            Newsletter
                        </h2>
                        <p className="font-normal text-base my-[25px]  leading-[151%]">
                            {" "}
                            Lorem ipsum dolor sit amet, consectetur adipiscing
                            elit. Lorem eget varius viverra in.
                        </p>
                        <div className="flex">
                            <input
                                className=" pl-[18px] border border-[#FF5300] placeholder:text-[#7B7B7B]"
                                type="text"
                            ...
                            >
                                {" "}
                                <img
                                className="w-5 h-5 py-[18px] px-12"
                                    src={telegram}
                                    alt="telegram"
                                    width={20}
                                    height={20}
